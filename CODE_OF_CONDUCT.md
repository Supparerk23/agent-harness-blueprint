...
When an incident does occur, it is important to report it promptly. To report a possible violation, contact the project maintainers privately via GitHub (@Supparerk23) or by opening a confidential report through [GitHub Security Advisories](https://github.com/Supparerk23/agent-harness-blueprint/security/advisories/new) if the matter involves sensitive information.
